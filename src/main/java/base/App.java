...
public class App {
    ...
    public static void main(String[] args) {
        App myApp = new App();
        int eu = myApp.euros();
        double exR = myApp.exchangeRate();
        final double usd = Math.round(eu * exR);
        String outputString = myApp.generateOutputString(eu, exR, usd);
    ...
    public String generateOutputString(int eu, double exR, double usd) {
        return "81 euros at an exchange rate of 1.3751 is\n" +
                "111.38 U.S. dollars.";
    }
}
